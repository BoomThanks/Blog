...
## <a name="php">PHP命名规范</a><a name="appendix1"><sup>①</sup></a> <a href="#top">↑</a>
...
## <a name="vue">vue编码规范</a><a name="appendix1"><sup>②</sup></a> <a href="#top">↑</a>
...
> 1、PHP代码规范 [PHP PSR 标准规范](https://laravel-china.org/docs/psr)

> 2、vue代码规范 [风格指南](https://cn.vuejs.org/v2/style-guide/)